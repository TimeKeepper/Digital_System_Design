...
HD_PWD='E:/project/single/Digital_System_Design/II/project_2/project_2.runs/FIFO_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_2.tcl
