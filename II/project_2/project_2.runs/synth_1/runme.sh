...
HD_PWD='E:/project/single/Digital_System_Design/II/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log II_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source II_2.tcl
