...
HD_PWD='E:/project/single/Digital_System_Design/II/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log II_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source II_2.tcl -notrace
