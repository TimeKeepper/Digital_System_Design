...
#
# Generated by export_simulation on Fri Nov 15 18:36:53 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BRAM_number.sh' script.

./BRAM_number.sh -reset_run
...
./BRAM_number.sh -noclean_files

For more information on the script, please type './BRAM_number.sh -help'.
