...
#
# Generated by export_simulation on Sun Nov 17 11:00:23 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BRAM_subui.sh' script.

./BRAM_subui.sh -reset_run
...
./BRAM_subui.sh -noclean_files

For more information on the script, please type './BRAM_subui.sh -help'.
