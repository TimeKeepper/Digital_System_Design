...
#
# Generated by export_simulation on Fri Nov 15 18:37:34 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BRAM_button.sh' script.

./BRAM_button.sh -reset_run
...
./BRAM_button.sh -noclean_files

For more information on the script, please type './BRAM_button.sh -help'.
