...
set_property PACKAGE_PIN P19 [get_ports io_vga_sync_hsync]						
	set_property IOSTANDARD LVCMOS33 [get_ports io_vga_sync_hsync]
set_property PACKAGE_PIN R19 [get_ports io_vga_sync_vsync]						
	set_property IOSTANDARD LVCMOS33 [get_ports io_vga_sync_vsync]
set_property PACKAGE_PIN U16 [get_ports io_vga_sync_valid]						
	set_property IOSTANDARD LVCMOS33 [get_ports io_vga_sync_valid]