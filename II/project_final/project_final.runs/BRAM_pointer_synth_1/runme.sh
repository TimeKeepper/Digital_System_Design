...
HD_PWD='E:/project/single/Digital_System_Design/II/project_final/project_final.runs/BRAM_pointer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_pointer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_pointer.tcl
