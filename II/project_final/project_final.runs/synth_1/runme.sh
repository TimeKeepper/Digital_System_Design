...
HD_PWD='E:/project/single/Digital_System_Design/II/project_final/project_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log II_final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source II_final.tcl
