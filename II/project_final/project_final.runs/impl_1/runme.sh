...
HD_PWD='E:/project/single/Digital_System_Design/II/project_final/project_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log II_final.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source II_final.tcl -notrace
