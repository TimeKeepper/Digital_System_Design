...
HD_PWD='E:/project/single/Digital_System_Design/II/project_final/project_final.runs/BRAM_subui_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_subui.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_subui.tcl
