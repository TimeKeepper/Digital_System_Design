...
HD_PWD='E:/project/single/Digital_System_Design/II/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log II_4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source II_4.tcl -notrace
