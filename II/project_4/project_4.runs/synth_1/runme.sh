...
HD_PWD='E:/project/single/Digital_System_Design/II/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log II_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source II_4.tcl
