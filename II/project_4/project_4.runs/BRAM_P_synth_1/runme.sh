...
HD_PWD='E:/project/single/Digital_System_Design/II/project_4/project_4.runs/BRAM_P_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_P.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_P.tcl
