...
#
# Generated by export_simulation on Wed Nov 13 13:03:51 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BRAM_framea.sh' script.

./BRAM_framea.sh -reset_run
...
./BRAM_framea.sh -noclean_files

For more information on the script, please type './BRAM_framea.sh -help'.
