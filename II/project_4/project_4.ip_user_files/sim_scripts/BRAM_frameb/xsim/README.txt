...
#
# Generated by export_simulation on Wed Nov 13 13:13:55 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BRAM_frameb.sh' script.

./BRAM_frameb.sh -reset_run
...
./BRAM_frameb.sh -noclean_files

For more information on the script, please type './BRAM_frameb.sh -help'.
