...
#
# Generated by export_simulation on Thu Nov 14 01:35:58 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './BRAM_pointer.sh' script.

./BRAM_pointer.sh -reset_run
...
./BRAM_pointer.sh -noclean_files

For more information on the script, please type './BRAM_pointer.sh -help'.
