...
#
# Generated by export_simulation on Fri Sep 13 10:57:28 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './ps2_mouse_0.sh' script.

./ps2_mouse_0.sh -reset_run
...
./ps2_mouse_0.sh -noclean_files

For more information on the script, please type './ps2_mouse_0.sh -help'.
