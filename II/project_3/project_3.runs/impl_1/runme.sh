...
HD_PWD='E:/project/single/Digital_System_Design/II/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log II_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source II_3.tcl -notrace
