...
HD_PWD='E:/project/single/Digital_System_Design/II/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log II_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source II_3.tcl
