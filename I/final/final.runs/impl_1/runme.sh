...
HD_PWD='E:/project/single/Digital_System_Design/I/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Homework.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Homework.tcl -notrace
